...
<div class="bg-gray-900 rounded-md px-4 py-4 max-w-screen-sm mt-2">
    ...
    <div class="bg-gray-200 px-4 py-4"> 
        ...
        <div class="mb-1 font-bold">
            <input type="text" placeholder="Store Name" class="h-6 w-full" name="">
        </div>
        <div class="mb-1 font-bold">
            
            <input type="text" placeholder="Full Name" class="h-6 w-full" name="">
        </div>

        <div class="mb-1 font-bold">
            
            <input type="text" placeholder="Phone Number" class="h-6 w-full" name="">
        </div>

        <div class="mb-1 font-bold">
            
            <input type="text" placeholder="Address" class="h-6 w-full" name="">
        </div>

        <div class="mb-1 font-bold">
            
            <input type="text" placeholder="Email Address" class="h-6 w-full" name="">
        </div>
