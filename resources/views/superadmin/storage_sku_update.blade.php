...
@section('superadmin-body')
        ...
        <div class="bg-gray-900 rounded-md p-2 md:px-4 md:py-4 max-w-screen-sm mt-4">
                <form method="POST" action="{{route('storageskuupdatestore', ['storageSku' => $storageSku -> id])}}">
                    @csrf
                    @method('PUT')
                <div class="bg-gray-200 px-4 py-4">
                    ...
                    <div class="mt-4">
                        <button type="submit" class="p-1 bg-teal-500 text-gray-200 font-bold hover:bg-teal-600 rounded-sm text-xs shadow-md">Submit</button>
                    </div>
