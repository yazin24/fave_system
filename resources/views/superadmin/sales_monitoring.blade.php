...
<div class="w-full">
    <div class="flex flex-row">
        ...
        <div class="ml-4">
            ...
            <button class="bg-gray-900 hover:bg-gray-800 px-1 py0.3 rounded-sm font-bold text-gray-200 text-sm ml-2"><a href="{{route('salestiktokmonitoring')}}">Tiktok</a></button>
