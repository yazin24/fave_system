...
<div class="mt-2">
    <form method="POST" action="{{route('addstockstore', ['allProduct' => $allProduct -> id])}}">
        @csrf
        @method('PUT')
    <div class="bg-gray-900 rounded-sm p-1 max-w-screen-sm">
        <div class="bg-gray-200 px-4 py-4"> 
            ...
            <div class="flex flex-col mb-4"> 
                    ...
                    <h2 class="text-xs text-gray-800 font-bold mb-2">TOTAL QUANTITY: <span class="text-blue-600 font-bold capitalize">{{$allProduct -> sku_quantity}}</span></h2>
                 ...
                 <button type="submit" class="text-xs bg-teal-500 hover:bg-teal-600 font-bold text-gray-200 p-1 rounded-sm shadow-md">
                 Update Stocks
                </button>
            </div>
