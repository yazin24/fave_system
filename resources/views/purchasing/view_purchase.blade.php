               ...
               <div class="bg-white-900 text-gray-900 mt-1"> 
                ...
                <div class="flex flex-row">
                    <div class="mt-4 text-sm">
                         <h2 class="text-gray-800 font-bold">Requested By: <span class="text-green-600 font-bold">{{$purchase -> purchaseOrderCredentials -> requested_by}}</span></h2>
                        <h2 class="text-gray-800 font-bold">Prepared By: <span class="text-green-600 font-bold">{{$purchase -> purchaseOrderCredentials -> prepared_by}}</span></h2>
                        <h2 class="text-gray-800 font-bold">Approved By: <span class="text-green-600 font-bold">{{$purchase -> purchaseOrderCredentials -> approved_by}}</span></h2>
                    </div>
