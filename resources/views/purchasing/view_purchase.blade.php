...
<h2 class="font-bold md:text-xl">Purchase Order Details</h2>
               ...
               <div class="bg-white-900 text-gray-900 mt-1"> 
                ...
                <div class="flex flex-row">
                    ...
                    <div class="ml-auto mt-4 font-bold mr-4 text-xs">
                       ...
                       <h2>Delivery Charge: ₱{{number_format($purchase -> del_charge, 2)}}</h2>
                       <h2 class="text-red-600">Total Amount: ₱{{number_format($purchase -> total_amount, 2)}}</h2>
                    </div>
                 </div>
         </div>
