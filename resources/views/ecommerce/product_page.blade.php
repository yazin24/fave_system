...
<div class="flex justify-center  rounded-sm w-72 mb-8 p-4 bg-gray-100 shadow-lg hover:scale-[1.05] hover: !scale-100!important duration-100">
  <div  class="w-72">
    ...
    <button class="bg-violet-700 hover:bg-violet-800 text-gray-200 p-1 rounded-sm font-bold w-full mb-1"><a href="{{route('homepage')}}"><i class="fa-solid fa-cart-shopping"></i> Add To Cart</a></button>
