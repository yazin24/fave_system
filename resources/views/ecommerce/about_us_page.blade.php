...
<div class="">
  <div class="pt-24 lg:mt-0 md:mt-8">
    <h2 class="text-center font-bold text-3xl text-violet-700">
      About Us
    </h2>
    ...
    <div class="flex flex-col md:flex-row md:mx-44 animate__animated animate__bounceInDown">
      ...
      <div class="p-8 md:p-12 flex justify-center">
        <i class="fa-solid fa-eye text-8xl text-violet-700 mt-0 md:mt-60 lg:mt-14"></i>
      </div>
    </div>
    <br>
    <br>
