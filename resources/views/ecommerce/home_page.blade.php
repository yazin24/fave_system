...
<div class="overflow-x-hidden">
    ...
    <div
      ...
      data-aos-duration="4000"
    >
      <div class="flex-col bg-violet-700 p-4 md:p-8 rounded-md mt-10 md:mt-36 shadow-md">
    ...
    <div
      ...
      data-aos-duration="4000"
    >
      <h2 class="md:mx-8 mx-8 mt-14 underline text-xl cursor-pointer">
        Want a Business? Lets talk!
      </h2>
    </div>

    <div
      class="flex flex-col md:flex-row my-24 md:my-8 md:mx-8 mx-4"
      data-aos="fade-left"
      data-aos-easing="ease-out-cubic"
      data-aos-duration="4000"
    >
