...
<div class="bg-gray-100">
  <h2 class="text-center pt-24 text-3xl font-bold text-violet-700 lg:mt-0 md:mt-8">
    Services
  </h2>
  <div class="flex flex-col justify-center items-center md:flex-row animate__animated animate__bounceInUp">
    <div
      data-aos="fade-right"
