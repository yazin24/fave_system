           ...
           <div class="bg-gray-900 p-2 rounded-sm shadow-md w-full lg:w-1/2">
                <div class="bg-gray-200 p-2 rounded-sm">
                    ...
                    <div class="flex flex-row justify-between">
                        <div class="mt-2">
                            <button class="bg-teal-500 p-1 text-xs rounded-md font-bold text-gray-200 shadow-md mr-1"><a href="{{route('storageskulog', ['storageSku' => $storageSku -> id])}}"><i class="fa-solid fa-scroll mr-1"></i></i>Log History</a></button>
                        </div>
