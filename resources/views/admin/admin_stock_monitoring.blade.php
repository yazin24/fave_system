    ...
    <table class="bg-gray-300 shadow-lg w-full">
        <thead>
            <tr class="md:h-8 bg-gray-900 border-b-2 text-gray-300 w-full">
                <th class="text-xs md:text-sm text-center w-1/4">ITEM NAME</th>
                <th class="text-xs md:text-sm text-center w-1/4">ITEM UNIT</th>
                <th class="text-xs md:text-sm text-center w-1/4">TOTAL QUANTITY</th>
                <th class="text-xs md:text-sm text-center w-1/4">DEFAULT PRICE</th>
            </tr>
        </thead>
        <tbody>
