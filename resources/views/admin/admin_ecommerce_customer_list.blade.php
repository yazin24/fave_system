    ...
    <table class="w-full shadow-md bg-gray-400">
        ...
        <tbody class="bg-gray-300">
            ...
            <tr class="h-10">   
                ...
                <td class="text-xs text-center border-b-2 font-bold"><a href="{{route('adminecommercecustomerdetails', ['customer' => $customer -> id])}}"><i class="fa-solid fa-eye text-lg text-yellow-500 hover:text-yellow-600"></i></a></td>
            </tr>
              @endforeach
        </tbody>
    </table>
