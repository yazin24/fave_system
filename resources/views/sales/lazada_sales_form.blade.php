...
<div class="rounded-sm shadow-lg bg-blue-900 p-1 lg:w-1/2 justify-center font-bold">
        ...
        <form method="POST" action="{{route('addlazadasales')}}">
            ...
            <div id="item-container" class="flex flex-col">
                ...
                <div class="flex flex-row justify-center">
                    ...
                    <div class="w-full">
                        <input type="text" class="w-full h-6 text-xs mb-0.5" value="@if($allProduct -> sku_size == 3785.41) 1Gal @elseif($allProduct -> sku_size == 1000) 1Liter @elseif($allProduct -> sku_size == 900) 900g @elseif($allProduct -> 180) 180g @endif " readonly>
