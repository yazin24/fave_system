...
<div class="rounded-md shadow-lg bg-orange-600 p-2 lg:w-1/2 justify-center">
    ...
    <div class="bg-gray-200 px-4 py-4 flex flex-col">
        ...
        <form>
            <div>
                <input type="text" placeholder="Order ID" class="h-6 w-full mb-2">
            </div>
            <div>
            ...
            <div class="mt-2">
                <button class="bg-orange-600 hover:bg-orange-700 font-bold p-1 text-xs rounded-md text-gray-200">Submit</button>
            </div>
        </form>
