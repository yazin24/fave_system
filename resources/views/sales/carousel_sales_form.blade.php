...
<h2 class="font-bold md:text-xl mt-2 text-red-600 mb-2">Carousel</h2>
@if($errors -> any())
...
<div class="rounded-sm shadow-lg bg-red-600 p-1 lg:w-1/2 justify-center font-bold">
    ...
    <div class="bg-gray-200 px-2 py-2">
        ...
        <form method="POST" action="{{route('addlazadasales')}}">
            ...
            <div class="mt-2">
                <button type="submit" class="bg-red-600 hover:bg-red-700 font-bold p-1 text-xs rounded-md text-gray-200">Submit</button>
            </div>
        </form>
